      ...
      <div className="max-w-5xl mx-auto px-4 py-12">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white dark:bg-gray-900 rounded-2xl shadow p-6 text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400">View your pending items.</p>
          </div>
          <div className="bg-white dark:bg-gray-900 rounded-2xl shadow p-6 text-center">
            <h2 className="text-xl font-semibold text-indigo-600">Messages</h2>
            <p className="text-gray-600 dark:text-gray-400">You have no new messages.</p>
          </div>
          <div className="bg-white dark:bg-gray-900 rounded-2xl shadow p-6 text-center">
            <h2 className="text-xl font-semibold text-indigo-600">Settings</h2>
            <p className="text-gray-600 dark:text-gray-400">Update your preferences.</p>
          </div>
        </div>
      </div>
    </div>
